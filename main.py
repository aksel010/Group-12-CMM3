...
fig = plt.figure(figsize=(18, 6))  # Changed height from 12 to 6 for single row
fig.suptitle('Group 12 - CMM3 Complete Analysis', fontsize=20, fontweight='bold')

# Plot 1: ODE (RK4 vs SciPy)
ax1 = plt.subplot(1, 3, 1)  # Changed from (2, 3, 1) to (1, 3, 1)
...
ax2 = plt.subplot(1, 3, 2)  # Changed from (2, 3, 2) to (1, 3, 2)
...
ax3 = plt.subplot(1, 3, 3)  # Changed from (2, 3, 3) to (1, 3, 3)
